...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/main_module.js":[function(require,module,exports) {
"use strict";
...
var setCards = document.querySelector("#match-list");
var btnSetCity = document.getElementById("btnSetCity");
...
var start = function start() {
  ...
  var localCity = localStorage.getItem("name_localCity");
...
var loadCities = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("city.list.min.json");
  ...
  return function loadCities() {
    return _ref.apply(this, arguments);
  };
}(); //searchCities - function: search cities in the list


var searchCities = function searchCities(searchText) {
...
var outputHtml = function outputHtml(matches) {
  if (matches.length > 0) {
    var html = matches.map(function (match) {
      return "<div class=\"card card-body mb-1\" id=\"d".concat(match.id, "\">\n        <h4 id=\"h").concat(match.id, "\">").concat(match.name, " (").concat(match.country, ") <span id=\"s").concat(match.id, "\" class=\"text-primary\">").concat(match.state, "</span></h4>\n        <small id=\"m").concat(match.id, "\" >Lat: ").concat(match.coord.lat, " / Long: ").concat(match.coord.lon, "</small></div>");
    }).join('');
...
var openWindowInfo = function openWindowInfo() {
...
search.addEventListener('input', function () {
  return searchCities(search.value);
}); //setCards - Event: click - When the user click on the card (city card), set the info 

setCards.addEventListener('click', function (e) {
  if (e.target.id.length > 0 && e.target.id != "match-list") {
    search.setAttribute("id_city", e.target.id.substring(1, e.target.id.length));
    citySelected = matches.find(function (city) {
      return city.id == parseInt(search.getAttribute("id_city"));
    });
    search.value = "".concat(citySelected.name, " (").concat(citySelected.country, ") ").concat(citySelected.state, " ");
    matchList.innerHTML = "";
...
btnSetCity.addEventListener('click', function () {
  openWindowInfo();
}); //  -------------------------------------------------------
//  Execution Secuence.
//  -------------------------------------------------------
...
var _main_module = require("./main_module.js");
...
(function () {
  (0, _main_module.init)();
  (0, _main_module.start)();
})();
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","../css/bootstrap.min.css":"css/bootstrap.min.css","./main_module.js":"js/main_module.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
